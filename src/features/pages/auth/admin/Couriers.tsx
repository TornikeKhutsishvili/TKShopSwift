              ...
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <div className="text-sm text-gray-500">COURIER001</div>
                  </div>
                </div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">courier@example.com</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Bike</td>
